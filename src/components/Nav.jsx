        ...
        <>
            ...
            <header className="header backdrop-blur-sm bg-white/30 dark:bg-gray-900/30">
                ...
                <NavLink to="/" className="bg-black dark:bg-white w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center shadow-lg rounded-xl transform hover:scale-105 transition-transform">
                    <p className="text-white dark:text-black font-bold text-sm sm:text-lg">SS</p>
                </NavLink>
                ...
                <nav className="hidden md:flex text-base lg:text-lg gap-4 lg:gap-8 font-medium items-center">
                    ...
                    <a className="bg-black dark:bg-white text-white dark:text-black px-3 lg:px-5 py-2 rounded-lg hover:shadow-lg transform hover:scale-105 transition-all duration-200 text-sm lg:text-base" target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1QTAthoWZTXq2kYoAlgVSTlxrDSpLqrM_/view">
                        {t('Resume', 'रिज़्यूमे')}
                    </a>
                </nav>
